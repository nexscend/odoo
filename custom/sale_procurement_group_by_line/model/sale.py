...
class SaleOrderLine(models.Model):
    ...
    def _action_launch_stock_rule(self, previous_product_uom_qty=False):
        ...
        for line in self:
            ...
            for warehouse_product_line_id in line.product_warehouse_ids:
                values = line._prepare_procurement_values(group_id=group_id, warehouse_id=warehouse_product_line_id.warehouse_id)
                product_qty = warehouse_product_line_id.qty_delivered
